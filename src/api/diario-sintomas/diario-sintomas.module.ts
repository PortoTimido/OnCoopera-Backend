...
@Module({
  ...
  providers: [
    {
      provide: DIARIO_SINTOMAS_REPOSITORY,
      useFactory: (prisma: PrismaService) =>
        new PrismaDiarioSintomasRepository(prisma),
    ...
    },
    {
      ...
      useFactory: (repository: DiarioSintomasRepository) =>
        new ListRegistrosDiariosUseCase(repository),
      inject: [DIARIO_SINTOMAS_REPOSITORY],
    },
    {
      provide: GetRegistroDiarioUseCase,
      useFactory: (repository: DiarioSintomasRepository) =>
        new GetRegistroDiarioUseCase(repository),
      inject: [DIARIO_SINTOMAS_REPOSITORY],
    },
    {
      provide: GetRegistroHojeUseCase,
      useFactory: (repository: DiarioSintomasRepository) =>
        new GetRegistroHojeUseCase(repository),
      inject: [DIARIO_SINTOMAS_REPOSITORY],
    },
    {
      provide: SaveRegistroHojeUseCase,
      useFactory: (
        repository: DiarioSintomasRepository,
        storage: VoiceNoteStorage,
      ) => new SaveRegistroHojeUseCase(repository, storage),
      inject: [DIARIO_SINTOMAS_REPOSITORY, VOICE_NOTE_STORAGE],
    },
    {
      provide: UpdateRegistroHojeUseCase,
      useFactory: (
        get: GetRegistroDiarioUseCase,
        save: SaveRegistroHojeUseCase,
      ) => new UpdateRegistroHojeUseCase(get, save),
      inject: [GetRegistroDiarioUseCase, SaveRegistroHojeUseCase],
    },
    PatientDiarioGuard,
  ],
})
